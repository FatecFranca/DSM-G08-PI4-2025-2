...
O projeto foi desenvolvido pelos integrantes: Gabriel Andrade Aleixo, Uriel Monte Paz Araujo, Hudson Ribeiro Barbara Junior, Gabriel de oliveira Camera., com foco em integração entre **API**, **IoT** e **aplicação Mobile**, visando a solução de um problema real utilizando tecnologias modernas e arquitetura modular.
